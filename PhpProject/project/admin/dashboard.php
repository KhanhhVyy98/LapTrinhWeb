...
<section class="dashboard">
   ...
   <div class="box">
      ...
      <p>Tổng phòng được đặt</p>
      <a href="bookings.php" class="btn">Xem phòng được đặt</a>
   </div>
   ...
   <div class="box">
      ...
      ?>
      <h3><?= $count_admins; ?></h3>
      <p>Tổng admin hiện có</p>
      <a href="admins.php" class="btn">Xem admin hiện có</a>
   </div>
   ...
   <div class="box">
      ...
      <a href="login.php" class="btn" style="margin-right: 1rem;">Đăng nhập</a>
      <a href="register.php" class="btn" style="margin-left: 1rem;">Đăng ký</a>
   </div>
