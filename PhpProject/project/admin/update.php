...
<section class="form-container">
   ...
   <form action="" method="POST">
      ...
      <input type="password" name="c_pass" placeholder="nhập lại mật khẩu mới" maxlength="20" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
