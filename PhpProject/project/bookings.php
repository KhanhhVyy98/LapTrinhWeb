...
<section class="bookings">
   ...
   <h1 class="heading">Lịch sử đặt phòng</h1>
   ...
   ?>
   <div class="box">
      <p>Tên khách hàng : <span><?= $fetch_booking['name']; ?></span></p>
      <p>Email : <span><?= $fetch_booking['email']; ?></span></p>
      <p>Số điện thoại : <span><?= $fetch_booking['number']; ?></span></p>
      <p>Ngày đến : <span><?= $fetch_booking['check_in']; ?></span></p>
      <p>Ngày đi : <span><?= $fetch_booking['check_out']; ?></span></p>
      <p>Số lượng phòng : <span><?= $fetch_booking['rooms']; ?></span></p>
      <p>Người lớn : <span><?= $fetch_booking['adults']; ?></span></p>
      <p>Trẻ em : <span><?= $fetch_booking['childs']; ?></span></p>
      <p>Id phòng : <span><?= $fetch_booking['booking_id']; ?></span></p>
   ...
   <div class="box" style="text-align: center;">
      <p style="padding-bottom: .5rem; text-transform:capitalize;">Không tìm thấy phòng!</p>
      <a href="index.php#reservation" class="btn">Đặt phòng ngay</a>
   </div>
   <?php
   }
   ?>
